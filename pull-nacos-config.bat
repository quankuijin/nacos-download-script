...
powershell -NoProfile -ExecutionPolicy Bypass -File "%PS_SCRIPT%" -ServerUrl "%SERVER_URL%" -DataId "%DATA_ID%" -Group "%GROUP%" -Namespace "%NAMESPACE%" -OutputDir "%OUTPUT_DIR%" -Username "%USERNAME%" -Password "%PASSWORD%"
goto end
